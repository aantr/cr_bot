...
what_gen = ['blue', 'bars'][1] # blue, bars
...
split_bbox_params = {  # format: [x_top_left, y_top_left, width, hight]
    ...
    "part2_2.16": (
        ...
        0.960,
        0.700,
    ),  # battle field (Arena), image size: (568, 896), origin: 592x1282, ratio: 2.16~2.17
    ...
    "part2_2.22": (
        ...
        0.960,
        0.690,
    ),  # old: 'part2_2400p': (0.020, 0.090, 0.960, 0.680),
    "part3_2.22": (0.000, 0.850, 1.000, 0.150),
    "part4_2.22": {"up": (0.130, 0.352, 0.747, 0.051)},
    # 600x1280
...
part3_bbox_params = (
    [  # Configure for card positions in part3, card position is left to right
